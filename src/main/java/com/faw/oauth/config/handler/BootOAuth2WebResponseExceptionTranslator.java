...
import com.faw.oauth.exception.BootOAuth2Exception;
 ...
 *
 * @author yanke
 * @Title: BootOAuth2WebResponseExceptionTranslator
 * @Package com.faw.oauth.config.handler
 * @Description:类描述
 * @Email yanke@cu-sc.com
 * @version: v1.0.0
 * @date: 2020/2/26/0026 17:52
...
public class BootOAuth2WebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) throws IOException {
        ...
        ResponseEntity<OAuth2Exception> response = new ResponseEntity("token错误", headers,
